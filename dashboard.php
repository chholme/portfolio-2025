...
<html lang="en">
  ...
  <body class="game-page-body">
    ...
    <div>
      <h2>Your Stats</h2>
      <p>Total Points: <?= $stats['total_points'] ?? '0' ?></p>
      <p>Achievements Unlocked: <?= $stats['achievements'] ?? '0' ?></p>
    </div>

    <div>
      <h2>Your Saved Games</h2>
      <ul>
        <li><a href="games/bingo/index.html">Play Bingo</a></li>
        <li><a href="games/number-guess/index.html">Play Number Guess</a></li>
      </ul>
    </div>
